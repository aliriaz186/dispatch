...
<head>
    <base href="../../../">
    <meta charset="utf-8"/>
    <title>Priority Home Warranty</title>
...
{{--                    <img src="{{asset('media/logos/logo-4.png')}}">--}}
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver">
                    <div class="kt-grid__item kt-grid__item--middle">
                        <h3 class="kt-login__title">Priority Home Warranty</h3>
...
{{--                                <p style="color: black!important;"><span class="ml-5" style="font-size: 15px!important;cursor: pointer;" data-toggle="modal" data-target="#exampleModal">Forgot password?</span></p>--}}
                            </div>
