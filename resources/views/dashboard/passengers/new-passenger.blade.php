                        ...
                        <div class="kt-portlet__body">
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" name="actual_passenger_auto_id" id="passenger_auto_id"
                                           class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="passenger_password" id="passenger_password"
                                               class="form-control"
            ...
            $(function () {
                ...
                $(".listing_form").validate({
                    ...
                    rules: {
                        ...
                        passenger_email: {email: true, required: true},
                    ...
                    submitHandler: function (form, e) {
                        ...
                        $.ajax({
                            url: "{{env('APP_URL')}}/passenger/save",
                            type: 'POST',
                            dataType: "JSON",
                            data: data,
                                ...
                                if (result['status']) {
                                    ...
                                    setTimeout(function () {
                                        swal.fire({
                                            ...
                                            "timer": 1500,
                                            "onClose": function (e) {
                                                window.location.href = `{{env('APP_URL')}}/passengers`
                                            }
                                        })
                                    }, 2000);
                                } else {
